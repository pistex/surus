...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='historicalblog',
            name='thumbnail',
            field=models.ForeignKey(blank=True, db_constraint=False, default=1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='blog.image'),
        ),
        migrations.AddField(
            model_name='historicalblog',
            name='title',
        ...
        migrations.AddField(
            model_name='blog',
            name='thumbnail',
            field=models.ForeignKey(default=1, null=True, on_delete=models.SET(apps.blog.models.get_default_thumbnail), to='blog.image'),
        ),
        migrations.AddField(
            model_name='blog',
            name='title',
